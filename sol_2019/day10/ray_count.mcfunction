...
execute at @s if block ~ ~ ~ pink_terracotta run scoreboard players add COUNT REG 1
execute at @s if block ~ ~ ~ pink_terracotta run setblock ~ ~ ~ red_terracotta
...
execute at @s if block ~ ~ ~ gray_stained_glass run function aoc:sol_2019/day10/ray_count